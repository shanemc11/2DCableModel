...
#plot each simulation trajectory to display dynamic instability
#Note: only do this with a subset (~5 trajetories) or plotting will take a 
#long time
# with sns.axes_style(st):
#     plt.figure(figsize=(6,6))
#     #plot the simulation results            
...
#     plt.legend(prop={'size': 20}) 
#     plt.tight_layout()
#     plt.savefig('230520_sim_traj_three_rows.svg')    
